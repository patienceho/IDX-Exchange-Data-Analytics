...
# This script concatenates all CRMLSListing monthly files from January 2024 through the
...
COMBINED_OUTPUT = "CombinedCRMLSListing.csv"
RESIDENTIAL_OUTPUT = "CombinedCRMLSListing_Residential.csv"
