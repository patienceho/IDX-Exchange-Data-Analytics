...
# week2_filter_sold.py
# Reads the week1 combined sold dataset, documents PropertyType values,
# filters to Residential, and saves the filtered output.

INPUT_CSV = "week1_CombinedCRMLSSold.csv"
OUTPUT_CSV = "week2_FilteredCRMLSSold_Residential.csv"
...
def main() -> None:
    ...
    print(f"Loaded sold dataset: {df.shape[0]} rows, {df.shape[1]} columns")
    ...
    print(f"Saved Residential-only sold dataset to {OUTPUT_CSV}")
