...
# week2_eda_sold.py
# EDA on week1 combined sold dataset.
...
INPUT_CSV = "week1_CombinedCRMLSSold.csv"
FILTERED_CSV = "week2_FilteredCRMLSSold_Residential.csv"
NULL_SUMMARY_CSV = "week2_null_summary_sold.csv"
NUMERIC_SUMMARY_CSV = "week2_numeric_summary_sold.csv"
MISSING_FLAGS_CSV = "week2_missing_flags_sold.csv"
...
def main() -> None:
    ...
    if FILTER_COLUMN in df.columns:
        ...
        pd.Series(uniques).to_csv(root / "week2_unique_propertytypes_sold.csv", index=False)
    else:
